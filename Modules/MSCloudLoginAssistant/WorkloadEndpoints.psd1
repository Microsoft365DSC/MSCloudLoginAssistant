@{
    ...
    AdminAPI              = @{
        ...
        AzureGermanyCloud = @{ Scope = '{Resource}/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de' }
    ...
    AzureDevOPS           = @{
        ...
        AzureGermanyCloud = @{ HostUrl = 'https://dev.azure.com'; Scope = '{Resource}/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de' }
    ...
    DefenderForEndpoint   = @{
        ...
        AzureGermanyCloud = @{ HostUrl = 'https://api.securitycenter.microsoft.com/'; Scope = 'https://api.securitycenter.microsoft.com/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de' }
    ...
    EngageHub             = @{
        ...
        AzureGermanyCloud = @{ ClientId = ''; Scope = 'https://engagehub.microsoft.com/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de'; APIUrl = 'https://api.engagecenter.microsoft.com' }
    ...
    Fabric                = @{
        ...
        AzureGermanyCloud = @{ HostUrl = 'https://api.fabric.microsoft.com'; Scope = 'https://api.fabric.microsoft.com/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de' }
    ...
    Licensing             = @{
        ...
        AzureGermanyCloud = @{ HostUrl = 'https://licensing.m365.microsoft.com'; Scope = '{Resource}/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de' }
    ...
    O365Portal            = @{
        ...
        AzureGermanyCloud = @{ HostUrl = 'https://admin.microsoft.com'; Scope = 'https://admin.microsoft.com/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de' }
    ...
    PowerPlatformREST     = @{
        ...
        AzureGermanyCloud = @{ Scope = 'https://service.powerapps.com/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de'; Audience = 'https://service.powerapps.com/'; BapEndpoint = 'api.bap.microsoft.com' }
    ...
    SharePointOnlineREST  = @{
        ...
        AzureGermanyCloud = @{ HostUrl = '{AdminUrl}'; Scope = '{AdminUrl}/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de' }
    ...
    Tasks                 = @{
        ...
        AzureGermanyCloud = @{ HostUrl = 'https://tasks.office.com'; Scope = 'https://tasks.office.com/.default'; AuthorizationUrl = 'https://login.sovcloud-identity.de'; ResourceUrl = 'https://tasks.office.com' }
