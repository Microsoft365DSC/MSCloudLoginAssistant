...
@{
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            LicenseUri = 'https://github.com/Microsoft365DSC/MSCloudLoginAssistant/blob/Dev/LICENSE'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/Microsoft365DSC/MSCloudLoginAssistant'

            # A URL to an icon representing this module.
            # IconUri = ''

            # ReleaseNotes of this module
            ReleaseNotes = '* Removed the dependency on Microsoft.Graph.Beta.Identity.DirectoryManagement module.
* Improved the handling with CustomEnvironment connection profiles.'
